...
% rBottle1------------------------------------------------------------
    ...
    % Pick
    rBottle1(3,4) = rBottle1(3,4) + 0.16;
...
% 
%     Pick
%     bBottle1(3,4) = bBottle1(3,4) + 0.23;
...
mat_R_T_M(3,4)=mat_R_T_M(3,4)+.095;
