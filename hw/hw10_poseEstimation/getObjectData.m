...
%--------------------------------------------------------------------------
    ...
    ptCloud_tform_cam = pctransform(ptCloud_base,tform_to_cam);  %complete code here%

    % TODO: Also do for non-plane specific points nonPlane_pic with tform_to_cam
    nonPlane_tform_cam = pctransform(nonPlane_pic,tform_to_cam);  %complete code here%
    ...
    for i = 1: numOfObjects
        ...
        % To improve: We have a function already for this need to integrate
        col2 = rotation(:,2);
        col1 = rotation(:,1);
